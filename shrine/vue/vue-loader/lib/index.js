...
const templateLoaderPath = require.resolve ('./loaders/templateLoader')
const stylePostLoaderPath = require.resolve ('./loaders/stylePostLoader')
...
var component = normalizer(
  ...
  `.trim () + `\n`
	...
	if (!isProduction) {
		...
		// Libraries can opt-in to expose their components' filenames in production
		// builds. For security reasons, only expose the file's basename in
		// production.
